...
//Last modified: Sun, Apr 05, 2026 07:08:08 PM
//Codeset: 1252
...
fileInfo "UUID" "CCE83B8C-4976-8EC0-5968-8DB00241CB63";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "A99A115B-2B40-A95A-EB94-24A6C71E6B67";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -7.0546400539238849 7.540381689801718 25.624295608774943 ;
	setAttr ".r" -type "double3" -8.1383527296333558 -11.399999999999903 1.0139269252111743e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "23F191FC-AA4C-36B2-3112-5F83AEC65EF3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 24.67111638983317;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F21B669E-4058-C308-1ADB-F39FA2C5522B";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "14B43468-41C1-632F-46C4-1A823368145E";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "23AA63A8-4427-D6C2-6FB4-239C12EA98E3";
createNode displayLayerManager -n "layerManager";
	rename -uid "29F27EEC-4885-315E-BF22-EE90D7B3AA09";
createNode displayLayer -n "defaultLayer";
	rename -uid "AD86C33F-B446-9A72-33B8-0B9D3BFC2C83";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "350A8A08-4869-A64E-E16A-C7A0835642C9";
...
createNode animCurveTL -n "Beefy_rFootIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 -0.3 25 -0.3 50 -0.3 75 -0.3 81 0 87 1
		 100 1.6 129 1.6;
createNode animCurveTL -n "Beefy_rFootIKC_translateY";
	rename -uid "867171A3-4DEA-18EF-2CAC-0397E3086334";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 25 1.4151556311133601e-16 50 1.4151556311133601e-16
		 75 1.4151556311133601e-16 81 -0.5 87 -2.5 100 -1.6 129 -1.6;
createNode animCurveTL -n "Beefy_rFootIKC_translateZ";
	rename -uid "81E2C377-441D-3E0B-33EB-C38F0641342C";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 25 -0.5 50 -0.5 75 -0.5 81 -1.2 87 -1.9999999999999998
		 100 -1.3 129 -1.3;
createNode animCurveTA -n "Beefy_rFootIKC_rotateX";
	rename -uid "583777F9-454E-22D0-1AD4-F7BF4F5CFDAD";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 25 0 50 0 75 0 81 0 87 0 100 0 129 0;
...
createNode animCurveTA -n "Beefy_rFootIKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 25 0 50 0 75 0 81 0 87 0 100 -90 129 -90;
...
createNode animCurveTL -n "Beefy_lFootIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0.25 25 0.25 50 0.25 75 0.25 81 0.25 87 0.25
		 100 0.25 129 0.25;
...
createNode animCurveTL -n "Beefy_lFootIKC_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 25 0 50 0 75 0 81 0.5 87 1.2 100 1.2
		 129 1.2;
...
createNode animCurveTA -n "Beefy_Neck01C_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 25 -10 38 -29.999999999999996 50 -20
		 75 -10 100 -10 129 -10;
createNode animCurveTA -n "Beefy_Neck01C_rotateY";
	rename -uid "78B6ED4C-4780-9C57-09E3-3F969759AE74";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 25 0 38 0 50 0 75 0 100 0 129 0;
...
createNode animCurveTA -n "Beefy_ROOTC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 25 0 38 0 50 0 75 0 81 0 87 0 100 0
		 129 0;
...
createNode animCurveTA -n "Beefy_Spine01FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 25 14.999999999999998 38 12.000000000000002
		 50 14.999999999999998 75 14.999999999999998 81 0 87 0 100 0 129 0;
...
createNode animCurveTA -n "Beefy_Spine02FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  1 0 25 20 38 35 50 29.999999999999996 62 25
		 75 20 81 0 87 0 100 -3.0000000000000004 129 -3.0000000000000004;
createNode animCurveTA -n "Beefy_Spine02FKC_rotateY";
	rename -uid "3F8A9829-4E01-F133-E918-B8B5C0010B4B";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  1 0 25 0 38 0 50 0 62 0 75 0 81 0 87 0 100 0
		 129 0;
...
createNode animCurveTA -n "Beefy_Spine03FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  1 0 25 0 38 20 50 -10 62 -20 75 0 81 0 87 0
		 100 -0.5 129 -0.5;
...
createNode animCurveTA -n "Beefy_SpineTopIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 25 0 50 0 75 0 87 0 100 0 129 0;
...
createNode animCurveTA -n "Beefy_SpineTopIKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 25 0 50 0 75 0 87 -8 100 -3.0000000000000004
		 129 0;
...
createNode animCurveTL -n "Beefy_ROOTC_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 25 -0.1 38 -0.3 50 -0.5 75 -0.3 81 -1
		 87 -1.2 100 -1.2 129 -1.2;
...
createNode animCurveTL -n "Beefy_rWristIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  25 3.3 38 3.3 50 3.3 75 3.3 81 3.3 87 3.3
		 100 3.3 129 3.3;
...
createNode animCurveTL -n "Beefy_lWristIKC_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  25 0.8 38 0.5 50 0.4 75 0.8 81 0.8 87 0.8
		 100 0.8 129 0.8;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
...
createNode animCurveTA -n "Beefy_lWristIKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  25 -90 38 -90 50 -90 75 -90 81 -90 87 -90
		 100 -90 129 -90;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
