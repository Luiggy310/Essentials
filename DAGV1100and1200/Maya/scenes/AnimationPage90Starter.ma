...
//Last modified: Mon, Jan 26, 2026 06:52:16 PM
//Codeset: 1252
...
fileInfo "UUID" "014D8ED2-4321-0A6B-65E8-F1A8E217EE9D";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "1DFBA4A4-134A-59AA-2739-3C93ABFFD067";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.6123512532859328e-16 7.3184237480163574 44.430672302560552 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 43.933531060533269;
...
createNode transform -n "Elbow" -p "Arm";
	...
	setAttr ".rpt" -type "double3" -4.4408920985006262e-15 -2.4424906541753444e-14 0 ;
...
createNode transform -n "Hand" -p "Elbow";
	...
	setAttr ".rpt" -type "double3" 3.9968028886505635e-15 5.8286708792820718e-15 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2E6B995B-4D1A-B869-D2C4-5C9EBD79F126";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5A847A29-415F-9DE2-5193-758F08CE1478";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E0019C88-4DFE-F2FB-482C-A1B54DF92E77";
createNode displayLayerManager -n "layerManager";
	rename -uid "343F3373-4B90-3DA9-1142-38ACC4F0A4E5";
createNode displayLayer -n "defaultLayer";
	rename -uid "138E985A-7348-29D9-3700-8797FCF8ABC7";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8688BC13-487A-481D-1269-ED882BF3CCE3";
...
createNode animCurveTA -n "Hand_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 -45 3 -63.620006025692923 6 -22.651226753640671
		 12 45 15 64.381938866049069 20 -43.180710625560565 24 -45;
