...
//Last modified: Wed, Jan 28, 2026 05:58:59 PM
//Codeset: 1252
...
fileInfo "UUID" "A5EEEFED-4A93-A0F8-9CB4-D3A424CF0961";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "1DFBA4A4-134A-59AA-2739-3C93ABFFD067";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.6123512532859328e-16 7.3184237480163574 63.750139292528011 ;
	setAttr ".rpt" -type "double3" 6.3272010514534364e-18 2.9714423090115189e-17 -1.6236480919286815e-18 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8426FD61-B94B-9F60-1746-D0BED0796422";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 63.252998050500729;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -2.5490792427713985e-16 7.3184237480163574 0.49714124202728271 ;
...
createNode transform -n "Arm";
	...
	setAttr ".rpt" -type "double3" 1.7763568394002505e-15 -4.8849813083506888e-15 0 ;
...
createNode transform -n "Elbow" -p "Arm";
	...
	setAttr ".rpt" -type "double3" -3.5527136788005009e-15 -9.5923269327613525e-14 0 ;
...
createNode transform -n "Hand" -p "Elbow";
	...
	setAttr ".rpt" -type "double3" 1.7763568394002505e-15 9.2148511043887993e-15 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0DB689C6-4EBA-09F6-E100-19A16D0C14C4";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "178347D7-4F40-63B1-2E51-839FEA4EEBC0";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "31714577-458A-046A-FDCC-72BE1EA804B0";
createNode displayLayerManager -n "layerManager";
	rename -uid "3E6F4C99-4C10-49BF-212E-8EAB3E8774D0";
createNode displayLayer -n "defaultLayer";
	rename -uid "138E985A-7348-29D9-3700-8797FCF8ABC7";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EB28DBF2-42CF-51FF-74B3-7CBAA472A64E";
...
createNode animCurveTA -n "Hand_rotateZ";
	rename -uid "44C77709-4388-2BCF-5871-6C9CE3E93599";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -90 3 -45 6 -28 9 52 12 45 15 64.381938866049069
		 18 -33 20 -43.180710625560565 24 -90;
createNode animCurveTA -n "Arm_rotateZ";
	rename -uid "D21166C3-4879-7CB7-35D5-38B40BB1B720";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -45 12 45 24 -45;
createNode animCurveTA -n "Elbow_rotateZ";
	rename -uid "20125DEF-4ED5-8457-09E6-3686D5F73379";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 -90 5 -58.000350278116059 9 75 12 90 15 35
		 20 -86.19637307300124 24 -90;
select -ne :time1;
	setAttr ".o" 20;
	setAttr ".unw" 20;
