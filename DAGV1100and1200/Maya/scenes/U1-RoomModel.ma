...
//Last modified: Thu, Aug 28, 2025 08:06:16 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "0DBB1591-4E00-6364-28CA-95B4609B8CA9";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "72E37334-4079-EE02-B601-198787399ECD";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 23.54525165641541 23.755281514721172 23.54525165641541 ;
	setAttr ".r" -type "double3" -35.264389682754697 45.000000000000007 -1.7991934265579786e-14 ;
	setAttr ".rp" -type "double3" -3.7747582837255322e-15 -2.6645352591003757e-15 -7.1054273576010019e-15 ;
	setAttr ".rpt" -type "double3" 8.2044724864188083e-15 -1.6653104793154776e-14 5.7597574035571513e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1D71295B-41DE-4C84-F56A-D180BCE5475E";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 40.7815721459068;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 0.21002985830570253 0 ;
...
createNode transform -n "Stool";
	...
	setAttr ".t" -type "double3" 0 3.9206228406913644 1.9416536953883723 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "005BDE76-4CF0-34BE-7DE0-CD8CA407B55D";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F4B34984-4C1F-188E-8F07-0792241E9F55";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "57F45A65-4084-4268-20D9-B786CB4E8194";
createNode displayLayerManager -n "layerManager";
	rename -uid "04C3F2A7-4AE6-7673-EE19-A493CDABADEB";
createNode displayLayer -n "defaultLayer";
	rename -uid "4B780C3D-41A6-1475-EFD1-7F834B503A69";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B1556C37-45D4-5BE4-52DC-0EA71A00448D";
...
connectAttr "polyExtrudeFace15.out" "StoolShape.i";
