...
//Name: AnimationPage151-152Starter_LC.ma
//Last modified: Mon, Mar 02, 2026 06:47:56 PM
//Codeset: 1252
...
fileInfo "UUID" "55A29D57-499E-956F-D4F7-91B61446DC42";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "99AE300A-8742-A46D-6279-CCBF22DA318F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 15.833054687475205 5.1216125902638439 -1.1278185940057708 ;
	setAttr ".r" -type "double3" -10.538352729606677 96.600000000000676 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "45862811-F348-56B1-5498-F0BFE7C3E382";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.986922318678516;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2858C9CA-4EA7-783E-E3A3-59A3D97BE56F";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "134EB168-4E58-D295-2AD6-B689CAD2D3EB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CFBED06A-4FEA-39BC-78EB-A9A23BF1F334";
createNode displayLayerManager -n "layerManager";
	rename -uid "5AD97975-4752-9736-2868-048050DAD1B4";
createNode displayLayer -n "defaultLayer";
	rename -uid "FBD2DA5A-B94F-BBFA-FAE4-33841361672C";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D67A13EF-40EE-13A1-A7D4-E79A24302CF8";
...
createNode reference -n "Ultimate_Tailed_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -8.23207639249907253 0 0"
		2 "|Ultimate_Tailed_v1_0_1:AniM_tailed_Main|Ultimate_Tailed_v1_0_1:Rig_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_Grp|Ultimate_Tailed_v1_0_1:CTRL_vis_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_01_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_01" 
		...
		"rotate" " -type \"double3\" 8.92126430514475288 0 0"
		2 "|Ultimate_Tailed_v1_0_1:AniM_tailed_Main|Ultimate_Tailed_v1_0_1:Rig_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_Grp|Ultimate_Tailed_v1_0_1:CTRL_vis_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_04_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_04" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
		...
		"rotate" " -type \"double3\" 12.16719937953162933 0 0"
		2 "|Ultimate_Tailed_v1_0_1:AniM_tailed_Main|Ultimate_Tailed_v1_0_1:Rig_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_Grp|Ultimate_Tailed_v1_0_1:CTRL_vis_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_03_Grp|Ultimate_Tailed_v1_0_1:CTRL_kuyruk_03" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode reference -n "_UNKNOWN_REF_NODE_";
	rename -uid "CBA73D9F-4BD0-E1F2-6DC0-F9B3ABF761EF";
	setAttr ".ed" -type "dataReferenceEdits" 
		"_UNKNOWN_REF_NODE_"
...
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "06768004-471B-EE7B-5D16-168A8A98A030";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 13 0 25 1;
createNode animCurveTL -n "CTRL_Top_translateY";
	rename -uid "BBDE442E-4D86-8DDB-A52B-F7A1CB7CA4AB";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 0 7 0.3 13 -0.5 19 0.3 25 0;
createNode animCurveTA -n "CTRL_kuyruk_04_rotateX";
	rename -uid "C9F4E4BC-4C81-4B86-9454-C69F0E0FEBBE";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 25 4 22.592564091509441 7 -30.13959222732576
		 10 -33.450106220260295 13 -36.983225636101906 16 33.671147134264011 19 -27.516324333820897
		 22 -38.865802265045318 25 25;
createNode animCurveTA -n "CTRL_kuyruk_01_rotateX";
	rename -uid "DF898BAB-430D-59F7-BCCA-A1BBB417B15E";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 25 4 -4.9464582007320077 7 -17.619556940404966
		 10 -37.410832564110812 13 25 16 25 19 41.805415660833908 22 41.805415660833908 25 25;
createNode animCurveTA -n "CTRL_kuyruk_02_rotateX";
	rename -uid "9DEB41E3-4BA0-6BE1-2B55-5AA8C7350C6F";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 25 4 -4.9464582007320077 7 -17.619556940404966
		 10 -37.410832564110812 13 -21.231008718317131 16 -4.8761140796282438 19 -4.425593057483221
		 22 2.3940405500190183 25 25;
createNode animCurveTA -n "CTRL_kuyruk_03_rotateX";
	rename -uid "A51CD3E7-4045-7D8F-7409-FFBE18DF010F";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 25 4 22.592564091509441 7 -17.619556940404966
		 10 -37.410832564110812 13 -11.635182044806781 16 -23.593443809222947 19 -3.1029872731139201
		 22 16.215211918698888 25 25;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
...
// End of AnimationPage151-152Starter_LC.ma
