...
//Last modified: Mon, Feb 02, 2026 06:49:23 PM
//Codeset: 1252
...
fileInfo "UUID" "44BF88DC-468C-9D15-3D94-BAADB8ADF99A";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "C9712CCD-754C-F86E-AD2A-73826B605734";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 15.109706750737699 2.202560815536216 -0.67066181072284037 ;
	setAttr ".r" -type "double3" -1.199999999999162 92.399999999979514 0 ;
	setAttr ".rpt" -type "double3" 3.2594574539521347e-17 5.1010165104682086e-17 -6.374962225730849e-19 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "461DA5EF-F84A-C499-F69E-15ADE383DA43";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 15.111108628289228;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.015164340903299545 -0.5214732857829727 -0.855053207242916 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "56B8808D-42E4-97B7-56C7-259AB8EA5CB0";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B9B9E15F-4F7B-A192-97A5-E496EF76848D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "87C15FA0-4BAB-41EB-86C3-EF89E7E9189D";
createNode displayLayerManager -n "layerManager";
	rename -uid "545A56AD-48F0-05DE-49C4-44BB6A0E1366";
createNode displayLayer -n "defaultLayer";
	rename -uid "AC91CB9A-E140-CD7A-D861-648C94E9970F";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5C9692D4-4EC1-DF31-806F-4B8225D50FE5";
...
createNode reference -n "Ultimate_Walker_IK_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translateY" " 0.10664862747236636"
...
createNode animCurveTA -n "walker_lf_heel_ik_ctrl_rotateX";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -49.340403882877446 4 -0.83073952633049597
		 7 0 10 52.392742396943056 13 29.79089666100289 16 120.13644564231467 19 111.79151691762569
		 22 43.771816882880572 25 -49.340403882877446;
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateX";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -0.59818043844969848 4 -0.37077532297257659
		 7 -0.16138569630065835 10 -0.16138569630065835 13 -0.59818043844969859 16 -0.59818043844969859
		 19 -0.58795445954883052 22 -0.58795445954883052 25 -0.59818043844969848;
	setAttr -s 9 ".kit[0:8]"  1 3 3 3 3 3 3 3 
		3;
	setAttr -s 9 ".kix[0:8]"  1 1 1 1 1 1 1 1 1;
	setAttr -s 9 ".kiy[0:8]"  0 0 0 0 0 0 0 0 0;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -0.30438394322150897 4 -0.046667242290886701
		 7 0 10 1.0198050999524582 13 -0.30438394322150897 16 1.6633103820805482 19 1.3774277639916539
		 22 0.34183378291113731 25 -0.30438394322150897;
	setAttr -s 9 ".kit[0:8]"  1 3 3 3 3 3 3 3 
		3;
	setAttr -s 9 ".kix[0:8]"  1 1 1 1 1 1 1 1 1;
	setAttr -s 9 ".kiy[0:8]"  0 0 0 0 0 0 0 0 0;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateZ";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 1.5304729826177337 4 1.0138825772556272
		 7 7.5275198871534637e-17 10 0.1404044403933119 13 -1.5968641751059451 16 -1.1982511822298332
		 19 -1.0087663757426213 22 -1.2613481391296699 25 1.5304729826177337;
	setAttr -s 9 ".kit[0:8]"  1 3 3 3 3 3 3 3 
		3;
	setAttr -s 9 ".kix[0:8]"  1 1 1 1 1 1 1 1 1;
	setAttr -s 9 ".kiy[0:8]"  0 0 0 0 0 0 0 0 0;
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_toeRoll";
	...
	setAttr ".tan" 5;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 7 0 10 -34 13 -34 16 -34 19 34 22 -15
		 25 0;
	setAttr -s 9 ".kit[0:8]"  1 3 3 3 3 3 3 3 
		3;
	setAttr -s 9 ".kix[0:8]"  1 1 1 1 1 1 1 1 1;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateX";
	...
	setAttr -s 9 ".ktv[0:8]"  1 0.3937002828703261 4 0.3937002828703261
		 7 0.42324943204112908 10 0.42826631400269899 13 0.3937002828703261 16 0 19 0.14265395668948022
		 22 0.14265395668948022 25 0.3937002828703261;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	...
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -0.19811660970462755 4 0.52619402519135672
		 7 1.4254495815529102 10 0.0477609986749441 13 -0.19811660970462755 16 0 19 0 22 0.96920874525471579
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateZ";
	...
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -1.7300071133599884 4 -1.4346446097847203
		 7 -1.2603368367665173 10 -1.3060686032598718 13 1.429128326706022 16 0 19 -1.7470071144547712e-17
		 22 0.23059180360112019 25 -1.7300071133599884;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 5 
		5;
createNode animCurveTA -n "walker_rt_heel_ik_ctrl_rotateX";
	...
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 33.333355372013607 4 42.821446067689948
		 7 115.35465524312383 10 49.718341663276355 13 -48.599361011067316 16 0 19 0 22 37.666766346262335
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_toeRoll";
	...
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -34 4 -15 7 34 10 -34 13 0 16 0 19 0 22 -34
		 25 -34;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 5 
		5;
...
createNode animCurveTL -n "CTRL_Main_translateY";
	...
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -0.30909130845597321 4 -0.66943075557961729
		 7 0 10 0.10664862747236636 13 -0.309 16 -0.64056310784594417 19 0 22 0.107 25 -0.30909130845597321;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 5 
		5;
...
createNode reference -n "_UNKNOWN_REF_NODE_";
	rename -uid "D97360C4-4B3D-5120-B3BF-0B934A75FA11";
	setAttr ".ed" -type "dataReferenceEdits" 
		"_UNKNOWN_REF_NODE_"
