...
//Last modified: Mon, Apr 13, 2026 06:30:04 PM
//Codeset: 1252
...
fileInfo "UUID" "10E8D3EB-4ED5-873D-A4C4-DDB3F49F3E3D";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "A99A115B-2B40-A95A-EB94-24A6C71E6B67";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.222104136712586 12.494974146185545 33.659160065248052 ;
	setAttr ".r" -type "double3" -11.73835272959297 -12.199999999220852 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "23F191FC-AA4C-36B2-3112-5F83AEC65EF3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 33.631548599534256;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9719D740-4785-A9B9-2C00-E2849DD7BD9F";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A5AE51AC-47A7-836E-29E7-49AE702FA621";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7F0962E4-4AE5-2F66-16C6-199386F90E55";
createNode displayLayerManager -n "layerManager";
	rename -uid "87B28176-47F8-1189-9876-7597023A6C06";
createNode displayLayer -n "defaultLayer";
	rename -uid "AD86C33F-B446-9A72-33B8-0B9D3BFC2C83";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3A529E14-474E-7E34-427B-2EBD6F9C3545";
