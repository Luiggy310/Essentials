...
//Last modified: Fri, Apr 17, 2026 09:32:09 PM
//Codeset: 1252
...
fileInfo "UUID" "6CF83AC3-4C85-1CE8-E626-2A89B69BCA18";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "A99A115B-2B40-A95A-EB94-24A6C71E6B67";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -36.697173293675718 7.7177801074034464 -18.382542357926738 ;
	setAttr ".r" -type "double3" -3.3383527295457536 -92.199999999797114 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "23F191FC-AA4C-36B2-3112-5F83AEC65EF3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 39.9044336108594;
...
createNode animCurveTL -n "Bony_Main_CNT_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 7 0 13 0 19 0 25 0 50 0;
...
createNode animCurveTL -n "Bony_Main_CNT_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -22 7 -21 13 -20 19 -16 25 -12 50 12;
...
createNode animCurveTU -n "Bony_Main_CNT_GlobalScale";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1 7 1 13 1 19 1 25 1 50 1;
createNode animCurveTL -n "Bony_ROOTC_translateX";
	rename -uid "7AE0784D-4B52-7D90-47AE-DA9F552CF14C";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 4 0 7 0 13 0 19 0 22 0 25 0 50 0;
createNode animCurveTL -n "Bony_ROOTC_translateY";
	rename -uid "A4F0D82C-4B4F-F6AC-B94A-FCA1A3B575F0";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 -1.2 4 -0.6 7 -0.6 13 -1.2 19 -0.6 22 -1.2
		 25 0.3 50 -1.2;
createNode animCurveTL -n "Bony_ROOTC_translateZ";
	rename -uid "87AE10DA-4E04-9AA7-843E-849D57086967";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 0 4 0 7 0 13 0 19 0 22 0.34999999999999976
		 25 0.7 50 0;
...
createNode animCurveTA -n "Bony_rThumbJ1C_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -75 50 -75;
...
createNode animCurveTA -n "Bony_rThumbJ2C_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -59.999999999999993 50 -59.999999999999993;
...
createNode animCurveTA -n "Bony_rThumbJ3C_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -33 50 -33;
...
createNode animCurveTA -n "Bony_rFinger1J1C_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -70 50 -70;
...
createNode animCurveTA -n "Bony_rFinger1J2C_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -65 50 -65;
...
createNode animCurveTA -n "Bony_rFinger1J3C_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -29.999999999999996 50 -29.999999999999996;
...
createNode animCurveTA -n "Bony_rFinger2J3C_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -40 50 -40;
...
createNode animCurveTA -n "Bony_rPalmC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -14.999999999999998 50 -14.999999999999998;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -5 11 -12.000000000000002 19 -14.999999999999998
		 25 -12.000000000000002 50 -5;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateY";
	rename -uid "283873C3-490E-B1AD-A7CA-D687AC240CC2";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 25 11 59.999999999999993 19 -73 25 70
		 50 25;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateZ";
	rename -uid "7F8C3FC4-485D-1DD5-2E24-0D88816BF9A7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 -83 11 -90 19 -67 25 -92 50 -83;
createNode animCurveTU -n "Bony_rShoulderFKC_scaleX";
	rename -uid "E6FC3979-4A38-CAD5-1CCD-B6B85D039877";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  1 1 11 1 19 1 25 1 50 1;
...
createNode animCurveTA -n "Bony_rWristFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 25 -45 50 0;
...
createNode animCurveTL -n "Bony_lFootIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 7 0 13 0 19 0 22 0.024999999999999988
		 25 0.05 50 0;
createNode animCurveTL -n "Bony_lFootIKC_translateY";
	rename -uid "83230D4F-4592-FEBE-DB35-FFB94B6814C7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 7 0 13 0 19 1 22 -0.27977891974181757
		 25 0 50 0;
createNode animCurveTL -n "Bony_lFootIKC_translateZ";
	rename -uid "389B28E7-4734-7307-B982-9F90EEF699FA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 7 -2.3 13 -2.5 19 2.3 22 -0.09999999999999476
		 25 -2.5 50 0;
...
createNode animCurveTL -n "Bony_rFootIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 7 3.5527136788005009e-15 13 0 19 0
		 21 0 22 0 25 0 50 0;
createNode animCurveTL -n "Bony_rFootIKC_translateY";
	rename -uid "74538E0B-4734-6374-090D-9ABDDF4E7FAD";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 -3.918390561885183e-16 4 -5.4958380946040943e-16
		 7 -0.5 13 -7.0086947233848219e-17 19 -4.2002808522930283e-16 21 -0.6 22 -0.6 25 -3.5
		 50 -3.918390561885183e-16;
createNode animCurveTL -n "Bony_rFootIKC_translateZ";
	rename -uid "E4B0C5B8-43E0-CC5E-781A-DC82ACEE0224";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  1 2.2930428097433335 4 2.7 7 -1.2 13 -1.5
		 19 2.3 22 2 25 -3 50 2.2930428097433335;
createNode animCurveTL -n "Bony_rKneeIKC_translateX";
	rename -uid "88296832-42CA-00BE-3E02-4A890B8DFD61";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 25 0.0030728811614616066 50 0;
createNode animCurveTL -n "Bony_rKneeIKC_translateY";
	rename -uid "D5B09F1B-4F58-C4F1-58EB-C4A22DF80EA3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 25 2.1220800610368551 50 0;
createNode animCurveTL -n "Bony_rKneeIKC_translateZ";
	rename -uid "2F2E8C27-48C4-C148-33FA-A49205C07BD9";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 25 1.0304366167063488 50 0;
createNode animCurveTA -n "Bony_lFootIKC_rotateX";
	rename -uid "7F28DA24-443F-47F5-74C7-01960A593A3A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 0 7 0 13 0 19 0 22 0 25 0 50 0;
...
createNode animCurveTA -n "Bony_Neck01C_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -10 25 -10 50 -10;
...
createNode animCurveTA -n "Bony_rToeIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 17.864007030235001 7 0 13 0 19 -10 22 59.999999999999993
		 25 -44 50 17.864007030235001;
...
createNode animCurveTA -n "Bony_lToeIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 13 -10 19 0 22 10 25 65 50 0;
createNode animCurveTA -n "Bony_lToeIKC_rotateY";
	rename -uid "CD6F59B1-4D30-2228-7419-7F9B1D378B78";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0 13 0 19 0 22 0 25 0 50 0;
...
createNode animCurveTA -n "Bony_Spine02FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 10 25 -5 50 10;
...
createNode animCurveTA -n "Bony_Spine03FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 -2 25 2 50 -2;
...
createNode animCurveTA -n "Bony_Spine01FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 5 25 -5 50 5;
...
createNode animCurveTA -n "Bony_rFootIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  1 0 4 0 7 0 13 0 19 0 21 0 22 0 25 0 50 0;
